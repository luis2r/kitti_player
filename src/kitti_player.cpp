...
int getCalibration_bev(string dir_root, string camera_name, double *R, double* P)

{

    // string calib_cam_to_cam = dir_root + "calib_cam_to_cam.txt";
    string calib_cam_to_cam = dir_root + "/calib/000000.txt";
    ifstream file_c2c(calib_cam_to_cam.c_str());
    if (!file_c2c.is_open())
        return false;
...
//    sensor_msgs::CameraInfo ros_cameraInfoMsg;
    ...
    {
        if (
            !(getCalibration_bev(dir_root, "2", ros_cameraInfoMsg_camera02.R.data(), ros_cameraInfoMsg_camera02.P.data()) &&
              getCalibration_bev(dir_root, "3", ros_cameraInfoMsg_camera03.R.data(), ros_cameraInfoMsg_camera03.P.data()))
        )
        {
